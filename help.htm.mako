<%inherit file="_templates/site.mako" />
    <div id="torso">
        <div class="rascalcontent">
            <div id="lefttorso">
                <p>The Rascal is still under development, so there's no help to be had yet. If you're interested in learning more about the Rascal, there are a few possibilities listed at right.
            </div>
            <div id="righttorso">
                <p>Read the <a href="/docs/">documentation</a>.</p>
                <p>Read our <a href="/blog/">blog</a>.</p>
                <p>Join the mayhem in the <a href="/forum/">forums</a>.</p>
                <p>If you're still not satisfied, email Brandon.</p>
